...
def pre_main():
    TUSER = getpass.getuser()
    if TUSER == "root":
        print("( \033[0;32mOK\033[0;37m ) root access ")
        time.sleep(4)
        main()
    else:
